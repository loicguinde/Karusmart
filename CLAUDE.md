...
Ce workspace est le Jarvis personnel de Loïc. Il a été créé avec le Jarvis Starter Kit pour servir d'assistant IA personnel au quotidien.
...
Je m'appelle Loïc et je vis au Moule, en Guadeloupe. Je suis fonctionnaire d'État, ingénieur d'études à INRAE (agronome et économiste), et j'étudie les freins et leviers à la transition agroécologique de l'agriculture pour l'aide à la décision publique.

Mes objectifs prioritaires actuels sont d'apprendre à utiliser l'IA dans mon travail, de développer un outil Python d'optimisation des ressources agricoles, de superviser une exploitation expérimentale en agroécologie, et de produire des présentations et documents d'études de qualité.

À long terme, je veux développer une expertise reconnue dans mon domaine et faire construire mon logement individuel.

Le domaine où j'ai besoin du plus d'aide en ce moment : la création de contenu (textes, posts, vidéos) et le codage Python.
